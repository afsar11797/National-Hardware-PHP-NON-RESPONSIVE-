...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/pipe_wrench.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A pipe wrench is any of several types of wrench that are designed to turn threaded pipe and pipe fittings for assembly or tightening or disassembly or loosening.</p>
      <p>Brand:Ajay</p>
      <p class="price">₹280</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I was really disappointed with this pipe wrench. It didn't have the grip I was looking for, and the handle felt flimsy. It's definitely not worth the money.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Noah Parker</h3>
    ...
    <p class="review-text">The size and weight of this pipe wrench make it easy to handle. I appreciate the high-quality materials used in its construction.</p>
  </div>
</div>
</div>
