...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/carbon_brush.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>A carbon brush is a component used to conduct electrical current between the stationary and rotating parts of a motor. In a generator or motor, the commutator rotates on a shaft and the fixed carbon brush rides on it to permit the flow of electricity and complete a circuit.</p>
      <p>Brand:Ideal</p>
      <p class="price">₹120</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">These carbon brushes work fine, but they seem to wear out faster than expected. They get the job done, but I have to replace them more often than I'd like</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Ethan Cooper</h3>
    ...
    <p class="review-text">These carbon brushes were a waste of money. They didn't fit properly and barely worked at all. I ended up having to buy a different brand.</p>
  </div>
</div>
</div>
