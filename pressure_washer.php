...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/pressure_washer.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>A pressure washer or power washer is a high-pressure mechanical sprayer used to remove loose paint, mold, grime, dust, mud, and dirt from surfaces and objects such as buildings, vehicles and concrete surfaces.</p>
      <p>Brand:Karcher</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text"> Excellent pressure washer with great cleaning power. I use it for washing my car and it does an amazing job. No complaints at all.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This pressure washer is a game-changer! It makes cleaning my deck a breeze and is easy to operate. Highly recommend!</p>
  </div>
</div>
</div>
