...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/wire_gauge.jpg" alt="Product Image" width="250" height="250">
    </div>
    <div class="product-details">
      <p>Wire gauge is a measurement of wire diameter. This determines the amount of electric current the wire can safely carry, as well as its electrical resistance and weight.</p>
      <p>Brand:Kristeel</p>
      <p class="price">₹550</p>
      <form method="post" action="cart1.php">
      <input type="hidden" name="product_id" value="29">
      <button class="button" type="submit">Add to Cart</button>
      <a href="wishlist.php.php" class="wishlist.php-button">Add to wishlist.php</a>
      </form>
    </div>
  </div>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">Amazing wire gauge! Accurate and easy to use. Highly recommended.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Joshua Baker</h3>
    ...
    <p class="review-text">This wire gauge is decent. It gets the job done, but not the most precise. Average.</p>
  </div>
</div>
</div>
