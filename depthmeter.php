...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/depthmeter.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A depth gauge or depthmeter is an instrument for measuring depth below a reference surface. They include depth gauges for underwater diving and similar applications, and engineering instruments used to measure the depth of holes and indentations from a reference surface..</p>
      <p>Brand:Forbes</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The depth meter worked perfectly for my diving trip. Accurate readings and easy to use.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>David Cooper</h3>
    ...
    <p class="review-text">The depth meter did its job, but I found the instructions a bit confusing and had to figure things out on my own.</p>
  </div>
</div>
</div>
