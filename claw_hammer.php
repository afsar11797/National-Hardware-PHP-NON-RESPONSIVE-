...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/claw_hammer.jpg" alt="Product Image" width="300" height="400">
    </div>
    <div class="product-details">
      <p>A claw hammer is a hammer primarily used in carpentry for driving nails into or pulling them from wood. Historically, a claw hammer has been associated with woodworking, but is also used in general applications.</p>
      <p>Brand:Baum</p>
      <p class="price">₹280</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I've used this claw hammer on multiple projects and it's held up really well. The grip is comfortable and provides a secure hold, and the hammer itself is sturdy and well-made. </p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Christopher Ramirez</h3>
      <div class="rating">
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
    ...
    <p class="review-text">This claw hammer is the perfect size and weight for home repairs. The claw is sharp and easily removes nails without damaging the surrounding area.</p>
  </div>
</div>
</div>
