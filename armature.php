...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/armature.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>An armature is a device through which electric current is passed for generating torque (rotor). The current that passes through the rotor is sometimes called the armature current.</p>
      <p>Brand:Forbes</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I was skeptical about buying an armature online, but I am so glad I did. The armature arrived quickly and it was exactly what I needed. The price was very reasonable compared to other retailers I had checked. I am very satisfied with my purchase and will definitely buy from this seller again.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Jack Lee</h3>
    ...
    <p class="review-text">I purchased the armature for my power tool and it was a perfect replacement. The quality of the product is excellent and it was easy to install. My power tool now works like new again. I highly recommend this armature.</p>
  </div>
</div>
</div>
