...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/height_gauge.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A height gauge is a measuring instrument in which a slider with a measuring stylus moves relative to a measuring scale on a beam and in which this motion is along a single vertical axis nominally perpendicular to a reference plane on the instrument base.</p>
      <p>Brand:Forbes</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The height gauge is decent. It gets the job done, but it's not as accurate as I was hoping for.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">I was disappointed with this height gauge. The measurement markings were difficult to read and the tool felt flimsy in my hands.</p>
  </div>
</div>
</div>
