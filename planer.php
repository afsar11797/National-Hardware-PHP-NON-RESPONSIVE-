...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/planer.jpg" alt="Product Image" width="350" height="300">
    </div>
    <div class="product-details">
      <p>A planer is a type of metalworking machine tool that uses linear relative motion between the workpiece and a single-point cutting tool to cut the work piece.</p>
      <p>Brand:KPT</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">"I was really disappointed with this planer. It broke after just a few uses, and the customer service was terrible. I wouldn't recommend it to anyone.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Jacob Rivera</h3>
    ...
    <p class="review-text">I've used a lot of planers in my time, but this one is the best by far. It's sturdy, well-built, and gets the job done quickly and efficiently.</p>
  </div>
</div>
</div>
