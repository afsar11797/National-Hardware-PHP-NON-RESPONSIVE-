...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/bearing.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>Bearings are parts that assist objects' rotation. They support the shaft that rotates inside the machinery. Machines that use bearings include automobiles, airplanes, electric generators and so on.</p>
      <p>Brand:HCH</p>
      <p class="price">₹20</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I  needed a replacement bearing for my bike and decided to try out this brand. I was pleasantly surprised by the quality and durability of the bearing. It has been performing smoothly for months now, even with daily use.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Lucas Brown</h3>
    ...
    <p class="review-text">I recently purchased a set of these bearings for a DIY project and was disappointed with their performance. They seemed to wear down quickly and caused a lot of friction, making my project difficult to complete.</p>
  </div>
</div>
</div>
