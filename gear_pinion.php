...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/gear_pinion.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>A gear pinion is the smaller of two meshed gears in an assembly. Pinions can be either spur or helical type gears, and be either the driving or driven gear, depending on the application.</p>
      <p>Brand:Ideal</p>
      <p class="price">₹380</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">Great quality gear pinion, smooth operation and easy to install. Very satisfied with my purchase.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Samuel Morgan</h3>
    ...
    <p class="review-text">The gear pinion works flawlessly and has greatly improved the efficiency of my machine.</p>
  </div>
</div>
</div>
