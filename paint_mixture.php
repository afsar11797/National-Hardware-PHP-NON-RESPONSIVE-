...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/paint_mixture.jpg" alt="Product Image" width="280" height="280">
    </div>
    <div class="product-details">
      <p>Paint and patty mixer machine used to mix all type of products such as paint patty powder & all liquid and dissolvable products with high torque.</p>
      <p>Brand:HighMaxx</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I love this paint mixer! It's so easy to use and it saves me so much time. The machine is also very durable and well-made.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This paint mixer is amazing! It blends paint quickly and efficiently, making my job much easier. </p>
  </div>
</div>
</div>
