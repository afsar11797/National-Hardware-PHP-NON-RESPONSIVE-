...
<body>
  <header>
    <h1>Marble Cutter Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/marble_cutter.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>Marble Cutter is used for cutting tiles, marble and granite to required size and shape at construction sites or at home renovation projects. This machine can also be used for chamfer cutting operations. This versatile machine has been specially designed keeping easy serviceability in mind..</p>
      <p>Brand:Bosch</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The marble cutter machine is an absolute game-changer. It's easy to use, cuts smoothly, and saves a lot of time compared to manual cutting. I love it!</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">I'm impressed with this marble cutter machine. It cuts through the toughest of materials with ease and precision. Highly recommended!</p>
  </div>
</div>
</div>
