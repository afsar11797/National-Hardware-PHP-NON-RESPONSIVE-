...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/heat_gun.jpg" alt="Product Image" width="350">
    </div>
    <div class="product-details"> 
      <p>A heat gun, often referred to as a hot air blower, is a must-have tool for professionals, crafts people and DIY masters. Heat guns are commonly known for their use to strip paint and weld or bend plastics. However, these handy tools are so much more versatile than just plastic welding tools.</p>
      <p>Brand: Stanley</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The heat gun works fine, but it's not as powerful as I expected. It takes a while to heat up and doesn't work well on thicker materials.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Joshua Baker</h3>
    ...
    <p class="review-text">This heat gun is amazing! It heats up quickly and does a great job of shrinking plastic wrap on my windows. I highly recommend it!</p>
  </div>
</div>
</div>
