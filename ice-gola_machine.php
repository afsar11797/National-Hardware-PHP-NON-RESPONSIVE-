...
<body>
  <header>
    <h1>Ice Gola Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/ice-gola_machine.jpg" alt="Product Image">
    </div>
    <div class="product-details">
      <p>The Ice Gola Machine is a handy table top machine for shredding ice for making Ice Gola. The machine is hand operated and easy to use.It can be installed on a table in a road side shop or on a cart.The Ice Gola machine is made entirely of Cast iron and is very sturdy.</p>
      <p>Brand:Universal</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This ice gola machine is amazing! It makes perfect shaved ice every time and is so easy to use. My family loves it!</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Jack Lee</h3>
    ...
    <p class="review-text">I bought this ice gola machine for my daughter's birthday party and it was a huge hit! All the kids loved it and the ice was so refreshing on a hot day.</p>
  </div>
</div>
</div>
