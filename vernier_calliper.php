...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/vernier_calliper.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>A vernier calliper is defined as a measuring device that is used for the measurement of linear dimensions. It is also used for the measurement of diameters of round objects with the help of the measuring jaws.</p>
      <p>Brand:Mityupoyo</p>
      <p class="price">₹800</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This Vernier caliper is a great tool for accurate measurements. The build quality is impressive, and it provides precise readings every time.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Samuel Morgan</h3>
    ...
    <p class="review-text">The vernier caliper is easy to use and lightweight, making it perfect for measuring small parts. It has a smooth slide and accurate readings.</p>
  </div>
</div>
</div>
