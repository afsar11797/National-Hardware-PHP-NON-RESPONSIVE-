...
<body>
  <header>
    <h1>Sheet Bending Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/sheet_bending.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>A bending machine is a forming machine tool (DIN 8586). Its purpose is to assemble a bend on a workpiece. A bend is manufactured by using a bending tool during a linear or rotating move.</p>
      <p>Brand:Metro</p>
      <p class="price">₹98000</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This machine is a game-changer! It makes bending metal sheets so much easier and faster. The results are always precise and uniform.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>David Cooper</h3>
    ...
    <p class="review-text">This machine works fine, but it's not very user-friendly. It takes some time and practice to get used to it. The bending angle is also a bit limited.</p>
  </div>
</div>
</div>
