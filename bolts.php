...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/bolts.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>A washer is a thin, unthreaded piece that fits onto the bolt shaft. Its function is to spread the load of the connection over a greater area or to help prevent the fastener from loosening once installed. A nut pulls the work pieces together along the bolt shaft.</p>
      <p>Brand: Unbrako</p>
      <p class="price">₹350</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I've used a lot of different bolts, nuts, and washers over the years, but these are some of the best. They're well-made and fit together perfectly.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Henry Edwards</h3>
    ...
    <p class="review-text">These bolts, nuts, and washers worked perfectly for my DIY project. They were easy to use and held everything together securely.</p>
  </div>
</div>
</div>
