...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/2hp.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>For electric motors and other electrical power applications, one horsepower is defined as 746 Watts, so a two horsepower electric motor is capable of providing up to 1492 Watts of power.</p>
      <p>Brand:Crompton</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I purchased this 2hp motor pump for my farm and it has exceeded my expectations. It pumps water quickly and efficiently, and the motor runs smoothly without any issues. I'm very happy with this purchase and would highly recommend it to anyone in need of a reliable motor pump.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Isaac Martinez</h3>
      <div class="rating">
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
    ...
    <p class="review-text">This product is good, but could be better. I wish it had more features.</p>
  </div>
</div>
</div>
