...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/micrometer.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A micrometer is an instrument used for making precise linear measurements of dimensions such as diameter, thickness, and lengths of solid bodies. It is made of a C-shaped frame with a movable jaw operated by an integral screw.</p>
      <p>Brand:Forbes</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text"> I've used a lot of different micrometers in my time, and this one is by far the best. It's incredibly precise and very easy to read, even on small measurements.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This micrometer works fine, but it's nothing special. It gets the job done, but I've used others that were easier to handle and read.</p>
  </div>
</div>
</div>
