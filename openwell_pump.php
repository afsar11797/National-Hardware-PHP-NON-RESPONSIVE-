...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/openwell_pump.jpg" alt="Product Image" width="350" height="400">
    </div>
    <div class="product-details">
      <p>Open well submersible pumps are designed for open well applications, where the pump is fully submerged in water. These pumps can either be a single stage pump with an impeller and a volute casing, or a multistage pump similar to borewell submersible pumps.</p>
      <p>Brand:CRI</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This openwell pump is excellent! It's powerful and efficient, and has been working perfectly for my water supply needs.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Owen Wilson</h3>
    ...
    <p class="review-text">This openwell pump is okay. It gets the job done, but I've had a few issues with the motor overheating and shutting off. It's not bad for the price, though.</p>
  </div>
</div>
</div>
