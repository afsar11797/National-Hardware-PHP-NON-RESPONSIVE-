...
<body>
  <header>
    <h1>Monoblock Pump</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/monoblock_pump.jpg" alt="Product Image" width="350">
    </div>
    <div class="product-details">
      <p>A Monoblock pump is a mechanical device wherein the motor as well as the pump is assembled jointly within a similar shelter. The shaft of the pump system includes revolving parts.</p>
      <p>Brand:Crompton</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I am extremely satisfied with this pump. It's been working flawlessly for months and has improved the water flow in my home significantly.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Lucas Brown</h3>
    ...
    <p class="review-text">The pump works fine, but it's a bit noisy and doesn't seem to be as powerful as I was expecting.</p>
  </div>
</div>
</div>
