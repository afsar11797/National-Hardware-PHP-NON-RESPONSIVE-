...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/clampmeter.jpg" alt="Product Image" width="300" height="400">
    </div>
    <div class="product-details">
      <p>Clamp meters allow electricians to bypass the old-school method of cutting into a wire and inserting a meter's test leads into the circuit to take an in-line current measurement.</p>
      <p>Brand:Waco</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This clamp meter is a game changer for anyone working with electrical circuits. It's accurate, easy to use, and the LCD display is clear and easy to read. I'm very impressed with the build quality and performance of this tool.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Daniel Cook</h3>
    ...
    <p class="review-text">This clamp meter is okay, but I've had some issues with accuracy. It seems to work fine for smaller currents, but when I tried to measure a larger current, it gave me inconsistent readings. It's a decent tool for the price, but I would suggest looking at other options if you need something more reliable.</p>
  </div>
</div>
</div>
