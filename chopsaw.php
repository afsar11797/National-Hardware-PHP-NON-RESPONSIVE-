...
<body>
  <header>
    <h1>Chopsaw Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/chopsaw.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
    <p>The chop saw is a motorized woodworking power tool designed to accurately and precisely complete square and angled cuts in wood. It works by spinning a circular steel saw blade at high speed. The blade cuts through the wood, laid on the support table, when you push the handle downward.</p>
    <p>Brand:Bosch</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I recently purchased the chop saw machine and it has been a game changer for my woodworking projects. It's powerful and accurate, making clean cuts every time.Great value for the price!</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Noah Parker</h3>
    ...
    <p class="review-text">The chop saw machine is decent for small projects but I've had some issues with accuracy and it can be a bit loud. It gets the job done but I think there are better options out there.</p>
  </div>
</div>
</div>
