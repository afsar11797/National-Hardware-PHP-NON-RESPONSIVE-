...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/field_coil.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A field coil is an electromagnet used to generate a magnetic field in an electro-magnetic machine, typically a rotating electrical machine such as a motor or generator. It consists of a coil of wire through which a current flows.</p>
      <p>Brand:Masteck</p>
      <p class="price">₹900</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The field coil was easy to install and my machine is running smoothly again. </p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This field coil did the job, but it wasn't as durable as I had hoped. It started to wear down after a few months of use.</p>
  </div>
</div>
</div>
