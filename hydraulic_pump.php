...
<body>
  <header>
    <h1>Hydraulic Test Pump</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/hydraulic_pump.webp" alt="Product Image" width="400" height="350">
    </div>
    <div class="product-details">
      <p>Hydraulic Test Pump is a diagnostic technique to perform high pressure hydraulic testing of tubes, pipes, hoses, cylinder. Hydraulic testing of pressure vessels & boilers, hydraulic pressure testing of cross country pipe lines, valves, castings, components etc. for leaks or defects.</p>
      <p>Brand:Farheen</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This hydraulic pump is a game changer! It has made my work so much easier and faster.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Elijah Bailey</h3>
    ...
    <p class="review-text">I've been using this hydraulic pump for a few months now and it hasn't let me down yet. It's powerful, reliable and easy to use. Definitely worth the investment.</p>
  </div>
</div>
</div>
