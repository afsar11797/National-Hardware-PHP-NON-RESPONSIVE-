...
<body>
  <header>
    <h1>Ball Press Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/ball_press.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>A ball press, commonly shortened to press, is a machine tool that changes the shape of a work-piece by the application of pressure. The operator of a forming press is known as a press-tool setter, often shortened to tool-setter.</p>
      <p>Brand:JK</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I've been using the ball press machine for a few months now and it has been fantastic. It's durable and sturdy, and I've had no issues with it so far. The press is easy to operate, and the balls it produces are of high quality. It's also very easy to clean and maintain. Overall, I'm very satisfied with my purchase.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Benjamin Young</h3>
      <div class="rating">
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
        <span class="star">&#9734;</span>
    ...
    <p class="review-text">The ball press machine is decent for its price, but I've had some issues with it. It sometimes jams and requires manual intervention to clear, which can be frustrating. The balls it produces are not always consistent in size and shape, which can be a problem if you need uniform balls for your project. It's not the best machine out there, but it gets the job done if you're on a budget.</p>
  </div>
</div>
</div>
