...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/blower.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>Blower is equipment or a device which increases the velocity of air or gas when it is passed through equipped impellers. They are mainly used for flow of air/gas required for exhausting, aspirating, cooling, ventilating, conveying.</p>
      <p>Brand:Planet Power</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The blower is a little heavy, but it gets the job done. It's perfect for cleaning out the garage or blowing away snow from the sidewalks.T</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This blower is amazing! It's so powerful and can easily blow away leaves, dirt, and debris from my driveway and yard. Highly recommend it.</p>
  </div>
</div>
</div>
