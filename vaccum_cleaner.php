...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/vaccum_cleaner.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>A vacuum cleaner, also known simply as a vacuum or a hoover, is a device that causes suction in order to remove dirt from floors, upholstery, draperies, and other surfaces. It is generally electrically driven.</p>
      <p>Brand:Karcher</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This vacuum cleaner is amazing! It picks up even the tiniest of dust particles, and the attachments make cleaning every surface a breeze.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Joseph Coleman</h3>
      <div class="rating">
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
    ...
    <p class="review-text"> I'm really impressed with this vacuum cleaner. It's lightweight, easy to maneuver, and has great suction power.</p>
  </div>
</div>
</div>
