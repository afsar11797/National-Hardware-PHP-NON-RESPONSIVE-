...
<body>
  <header>
    <h1>Pillar Drill Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/pillar_drill.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>Pillar drills also referred to as drill press machines are versatile machines that can be used on a wide range of materials where single hole drilling is required.</p>
      <p>Brand:Vishal</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The pillar drill is an excellent addition to my workshop. It's sturdy and well-built, and I've had no issues drilling through a variety of materials.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Henry Edwards</h3>
    ...
    <p class="review-text">The pillar drill is a decent tool for the price. It gets the job done, but I've had some issues with the chuck loosening during use. Overall, it's a decent option if you're on a budget.</p>
  </div>
</div>
</div>
