...
<head>
    ...
    <title>circular_saw_machine</title>
...
<body>
  <header>
    <h1>Circular Saw Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/circular_saw_machine.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
    <p>A circular saw is a power-saw using a toothed or abrasive disc or blade to cut different materials using a rotary motion spinning around an arbor. A hole saw and ring saw also use a rotary motion but are different from a circular saw. Circular saws may also be loosely used for the blade itself.</p>
      <p>Brand:Bosch</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This circular saw machine is simply amazing! It is very easy to use and the precision of the cuts is remarkable. I have used it to cut various types of wood and it has never disappointed me. I highly recommend this product to anyone looking for a reliable circular saw.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Jacob Rivera</h3>
    ...
    <p class="review-text"> I recently purchased this circular saw machine and I am very pleased with my purchase. It is well-built and sturdy, and the blade is sharp enough to make clean cuts. The machine is also very easy to adjust and the depth gauge is very accurate. Overall, I am very happy with this product.</p>
  </div>
</div>
</div>
