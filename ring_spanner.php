...
<body>
  <header>
    <h1>Ring Spanner Set</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/ring_spanner.jpg" alt="Product Image" width="230" height="200">
    </div>
    <div class="product-details">
      <p>The ring spanner's connection with a fastener is very similar to that of a box spanner. The heads on a ring spanner set - each piece usually has a head at each end - are formed as a single closed loop containing a machined profile, which contacts the nut on all sides simultaneously.</p>
      <p>Brand:Tarparia</p>
      <p class="price">₹700</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I bought this set for my workshop and I'm very happy with it. The spanners are well made and durable. Great value for the price</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Gabriel Green</h3>
    ...
    <p class="review-text">The ring spanner set is decent.The sizes are perfect, it is what I expected for the price.</p>
  </div>
</div>
</div>
