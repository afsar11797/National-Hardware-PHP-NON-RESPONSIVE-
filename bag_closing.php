...
<body>
  <header>
    <h1>Bag Closing Machine</h1>
  </header>
  <br><br>
  <div class="container">
    <div class="product-img">
      <img src="Images/bag_closing.webp" alt="Product Image" width="300">
    </div>
    <div class="product-details">
      
      <p>A plastic bag heat sealer is a simple heater that, when pressed and applied to a thermoplastic bag, seals the bag together using a combination of pressure and melting. The two plastic parts are brought together and pressed against one another and heated.</p>
      <p>Brand: Seepack</p>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The bag closing machine I bought works decently well. It gets the job done, but it's not the fastest or most efficient machine out there. It requires frequent maintenance and adjustments to keep it running smoothly. While it's not perfect, it's a decent option for someone on a budget looking for a basic bag closing machine.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">I am extremely satisfied with the bag closing machine I purchased. It has made my work so much easier and efficient. The machine is easy to operate and maintain. It does a great job of closing bags quickly and neatly.</p>
  </div>
</div>
</div>
