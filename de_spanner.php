...
<body>
  <header>
    <h1>Open Ended Spanner</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/de_spanner1.jpg" alt="Product Image" width="280" height="280">
    </div>
    <div class="product-details">
      <p>A one-piece wrench with a U-shaped opening that grips two opposite faces of the bolt or nut.  Double-ended, with a different-sized opening at each end. The ends are generally oriented at an angle of around 15 degrees to the longitudinal axis of the handle. This allows a greater range of movement in enclosed spaces by flipping the wrench over.</p>
      <p>Brand:Taparia</p>
      <p class="price">₹500</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">The De-spanner is a decent tool, but it's nothing special. It does the job, but it's not as comfortable to hold as some other spanners I've used. Overall, it's an okay choice if you need a new spanner and don't want to spend too much.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Gabriel Green</h3>
    ...
    <p class="review-text">I've used the De-spanner for a few projects now, and it has performed flawlessly. The grip is comfortable and the jaws are precise, making it easy to use on a variety of bolts and nuts.</p>
  </div>
</div>
</div>
