...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/5hp.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A motor a '5HP' motor generally means that it is a motor rated for a constant power output of 5HP. If you're only using it to drive a 1HP load, the power consumed will also be a lot less than if it was driving a 5Hp load.</p>
      <p>Brand:Crompton</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I've been using this 5hp motor pump for my farm for over a year now and it's been working great. It has enough power to pump water from a deep well and it's very reliable. I haven't had any issues with it and I'm glad I invested in this quality pump.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Elijah Bailey</h3>
    ...
    <p class="review-text">This 5hp motor pump is a beast! It can handle heavy-duty pumping tasks with ease. I use it for my industrial cleaning business and it has never let me down. It's also surprisingly quiet for a pump of this size.</p>
  </div>
</div>
</div>
