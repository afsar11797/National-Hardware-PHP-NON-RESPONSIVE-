...
<body>
  <header>
    <h1>Pipe Bending Machine</h1>
  </header>
  <br><br>
  <div class="container">
    <div class="product-img">
      <img src="Images/pipe_bending.jpg" alt="Product Image" width="200" height="200">
    </div>
    <div class="product-details">
      <p>Pipe bending machines are used to bend tubes and pipes to produce finished parts. Tubes are structural, hollow conduits that are used as flow lines for fluids and gases in pneumatic, hydraulic, medical, and process applications.</p>
      <p>Brand:Bosch</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This pipe bending machine is fantastic! It's easy to use and gets the job done quickly. I highly recommend it to anyone in the industry.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Ethan Cooper</h3>
    ...
    <p class="review-text">I am impressed by the accuracy and precision of this pipe bending machine. It makes my job so much easier and I have never had any issues with it.</p>
  </div>
</div>
</div>
