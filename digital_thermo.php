...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/digital_thermo.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>Digital thermometers measure body temperature over a small temperature range centered around 37°C. Digital thermometers provide faster, more convenient measurements and also eliminate the environmental hazard of mercury in legacy thermometers.</p>
      <p>Brand:Arrow Space</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This thermometer is super accurate and gives a reading in just a few seconds. I love how easy it is to use, and it's perfect for taking temperatures of both adults and children.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Andrew Woods</h3>
    ...
    <p class="review-text"> I'm really disappointed in this thermometer. It's incredibly slow and sometimes gives me an error message instead of a temperature reading.</p>
  </div>
</div>
</div>
