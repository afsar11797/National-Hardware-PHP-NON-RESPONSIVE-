...
<html>
<head>
    <title>electric_chain_saw</title>  
...
<body>
  <header>
    <h1>Electric Chainsaw</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/electric_chainsaw.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>Electric chainsaws operate using a long, versatile cord, which can be plugged into any nearby power source. They do not use gasoline like a traditional chainsaw, and they do not use batteries like their smaller counterparts.</p>
      <p>Brand:ICann</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I was hesitant to buy an electric chainsaw, but this one exceeded my expectations. It's much quieter than a gas chainsaw and has plenty of power. Great value for the price.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">It's a decent chainsaw. It does the job, but I wish it had a longer bar and chain. Also, the chain tensioning system is a bit finicky.</p>
  </div>
</div>
</div>
