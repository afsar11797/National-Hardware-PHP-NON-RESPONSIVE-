...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/welding_machine.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>A welding machine is a powerful tool used to fuse two pieces of metal together. This machine holds the metal pieces in place, melts them, and uses pressure to join them. It is an essential tool for any construction-related job which requires metalwork.</p>
      <p>Brand:Camel</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I've used a lot of welding machines in my career, but this one is by far the best. It's reliable, efficient, and easy to use.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Jonathan Flores</h3>
      <div class="rating">
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
    ...
    <p class="review-text">The welding machine is decent. It gets the job done, but there's nothing particularly special about it. It's a bit on the heavy side and takes a while to warm up.</p>
  </div>
</div>
</div>
