...
<html>
<head>
    <title>profile_cutting_machine</title>  
...
<body>
  <header>
    <h1>Profile Cutting Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/profile_cutting.jpg" alt="Product Image" width="350" height="400">
    </div>
    <div class="product-details">
      <p>A profile cutting machine process in which an ionized gas at temperatures of more than 20,000 °C is used to melt and get rid of the material from the cut. During this process, an electric arc is placed between an electrode cathode and the piece being worked on anode.p>
      <p>Brand:Cruxweld</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This profile cutting machine is a game-changer! It has drastically reduced the amount of time and effort it takes to cut profiles. I'm very happy with my purchase.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This profile cutting machine gets the job done, but it's not the most user-friendly. It took me a little while to figure out how to use it properly. It's not a bad machine, but there are probably better options out there.</p>
  </div>
</div>
</div>
