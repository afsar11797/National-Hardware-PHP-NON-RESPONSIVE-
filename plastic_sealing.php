...
<body>
  <header>
    <h1>Plastic Sealing Machine</h1>
  </header>
  <br><br>
  <div class="container">
    <div class="product-img">
      <img src="Images/plastic_sealing.jpg" alt="Product Image" width="300">
    </div>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This plastic sealing machine is a game changer! It's so easy to use and produces perfect seals every time.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Daniel Cook</h3>
    ...
    <p class="review-text">This plastic sealing machine is okay. It does the job, but I've had some issues with it jamming and the seals not coming out as clean as I would like.</p>
  </div>
</div>
</div>
