...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/hammer_drill.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>A hammer drill, also known as a percussion drill or impact drill, is a power tool used chiefly for drilling in hard materials. It is a type of rotary drill with an impact mechanism that generates a hammering motion.</p>
      <p>Brand:Advance</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">"I'm very happy with this hammer drill. It's well-made, durable, and has a lot of useful features. Definitely worth the investment.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">This hammer drill is a beast! It's powerful, easy to handle, and got the job done quickly. Highly recommend it.</p>
  </div>
</div>
</div>
