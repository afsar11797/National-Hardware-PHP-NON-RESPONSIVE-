...
<body>
  ...
  <div class="container">
    <div class="product-img">
      <img src="Images/socket_set.jpg" alt="Product Image" width="300" height="300">
    </div>
    <div class="product-details">
      <p>A socket set consists of multiple different attachments in a variety of sizes that slot or snap onto the handle of a socket wrench, also known as a ratchet spanner, or similar turning tool.</p>
      <p>Brand:Jhalani</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This socket set is excellent! The sockets fit perfectly and the ratchet feels solid. Would highly recommend.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
    ...
    <p class="review-text">"For the price, this socket set is really impressive. The sockets are well-made and the case is sturdy. A great value!</p>
  </div>
</div>
</div>
