...
session_start();
  ...
  <body>
    ...
    <div class="container">
      <div class="product-img">
        <img src="Images/drill_machine.jpg" alt="Product Image" width="500" height="500">
      </div>
      <div class="product-details">
        <p>A drilling machine works by rapidly rotating a tool bit and lowering it into the desired area at a predefined tool speed and feed rate to create cylindrical holes in a workpiece. The workpiece must be securely held in place on the drill table during drilling operations using vises and clamps.</p>
        <p>Brand:Bosch</p>
  ...
  <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    ...
    <div class="review-card">
      ...
      <p class="review-text">This drill machine is amazing! It's very powerful and easy to use. I was able to complete my DIY project in no time with this drill.</p>
    </div>
    <div class="review-card">
      <div class="review-header">
        <h3>William Richardson</h3>
        <div class="rating">
          <span class="star">&#9733;</span>
          <span class="star">&#9733;</span>
          <span class="star">&#9733;</span>
      ...
      <p class="review-text"> I'm very impressed with this drill machine. It's very well-built and durable, and it comes with a lot of different drill bits. It's definitely a great value for the price.</p>
    </div>
  </div>
  </div>
