...
<body>
  <header>
    <h1>Slab Cutter Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/slab_cutter.jpg" alt="Product Image" width="400" height="400">
    </div>
    <div class="product-details">
      <p>A slab cutter is used when you have to remove more amount of material from the work piece. By using roughing end mills, we obtain a rough surface finishing. Roughing end mills are also famous as “rippa” cutters. They are more beneficial commercially and are used in various industrial applications.</p>
      <p>Brand:Extra Power</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This slab cutter made cutting through concrete slabs a breeze. It was easy to use and the blades lasted a long time.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Andrew Woods</h3>
    ...
    <p class="review-text">The slab cutter worked fine, but I was expecting it to be a bit more powerful. It got the job done, but it took longer than I had hoped.</p>
  </div>
</div>
</div>
