...
<head>
    ...
    <title>cotton_candy_machine</title>
    ...
    <div class="subheader">
      <div class="search">
        <form method="POST" action=""> 
          ...
          <a style="text-decoration:none"  href="wishlist"><img src="./Images/wishlist.png" alt="" width="27" height="27"> <a href="cart.php"><img src="images/cart.jpeg" alt="" width="30" height="30"></a>
...
<body>
  <header>
    <h1>Cotton Candy Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/cotton_candy_machine.jpg" alt="Product Image" width="270" height="270">
    </div>
    <div class="product-details">
      <p>Typical machines used to make cotton candy include a spinning head enclosing a small "sugar reserve" bowl into which a charge of granulated, colored sugar is poured. Heaters near the rim of the head melt the sugar, which is squeezed out through tiny holes by centrifugal force.</p>
      <p>Brand:Universal</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">I absolutely love this cotton candy machine! It's easy to use and produces fluffy and delicious cotton candy in just minutes. Perfect for parties and events.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Matthew Morris</h3>
      <div class="rating">
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
        <span class="star">&#9733;</span>
    ...
    <p class="review-text">This machine is amazing! It's easy to set up and clean, and the cotton candy comes out perfectly every time. The kids at my daughter's birthday party couldn't get enough.</p>
  </div>
</div>
</div>
