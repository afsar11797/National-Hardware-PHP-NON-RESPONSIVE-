...
<body>
  <header>
    <h1>Bench Grinder Machine</h1>
  </header>
  <br>
  <div class="container">
    <div class="product-img">
      <img src="Images/bench_grinder.jpg" alt="Product Image" width="350" height="350">
    </div>
    <div class="product-details">
      <p>A bench grinder is an appliance that is used to sharpen other tools. It is a must-have for your home workshop. Bench grinder has wheels that you can use for grinding, sharpening tools, or shaping some objects. Depending on the types and shape of the wheel, the use of a bench grinder can vary.</p>
      <p>Brand:Bosch</p>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <div class="review-card">
    ...
    <p class="review-text">This bench grinder is great for sharpening my tools. It's powerful and gets the job done quickly.</p>
  </div>
  <div class="review-card">
    <div class="review-header">
      <h3>Owen Wilson</h3>
    ...
    <p class="review-text">Easy to assemble and use. The adjustable speed control is a nice feature, and the wheels stay balanced during use.</p>
  </div>
</div>
</div>
